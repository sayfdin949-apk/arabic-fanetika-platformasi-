...
export const NAV: NavItem[] = [
  ...
  { to: "/speaking-club", label: "Speaking Club", icon: Mic2, roles: ALL, bottom: false, turlar: ["fonetika"] },
  { to: "/mehmon-ustozlar", label: "Mehmon ustozlar", icon: Globe, roles: ALL, bottom: false, turlar: ["fonetika"] },
  { to: "/ovoz", label: "Ovoz yozish", icon: Mic, roles: ALL, bottom: false, turlar: ["fonetika"] },
  { to: "/tarjimon", label: "Tarjimon", icon: Languages, roles: ALL, bottom: false },
  { to: "/multfilmlar", label: "Multfilmlar", icon: Tv2, roles: ALL, bottom: false, turlar: ["fonetika"] },
