...
export class LocalChatApi implements ChatApi {
  ...
  // Lokal rejimda Realtime yo'q — ChatView polling orqali yangilanadi
  subscribe(_guruhId: string, _onNew: () => void): () => void {
    return () => { /* no-op */ };
  }
}

// Re-export Role uchun (chatApi.ts ga import qilinar)
export type { Role };
